...
const TwitterIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={styles.socialIcon} aria-hidden>
            ...
            <div className={styles.container}>
                <div className={styles.grid}>
                    ...
                    <div className={styles.brandArea}>
                        ...
                        <p className={styles.brandDesc}>
                            A modern support experience resolving issues faster with intelligent routing and human expertise.
                        </p>
                    </div>

                    <div className={styles.linkGroup}>
                        <h4 className={styles.linkGroupTitle}>Resources</h4>
                        <Link href="#" className={styles.link}>Knowledge Base</Link>
                        <Link href="#" className={styles.link}>System Status</Link>
                ...
                <div className={styles.bottomBar}>
                    <div className={styles.copyright}>
                        © {currentYear} Insighta System. All rights reserved.
                    </div>
